...
def aadhaar2(field):
    while True:
        ad = input( "Enter the Aadhaar Number of the person whose "+field+" is to be updated:" )
        if len( ad ) == 12:
            print()
            break
        else:
...
def seltb():
    ...
    while ab == 'y':
        try:
            tbname = int(input( 'Which table would you like to choose (Enter the number associated):' ))
            tbname2 = tbname
...
engine.say("we present to you our project on covid 19 vaccine database management system made by Anish Murali and Mudit Biedaani")
engine.runAndWait()
...
while True:
    try:
        ...
        db = mysql.connector.connect( host="localhost",port="3307", user=username, passwd=password)
        cursor = db.cursor()
        engine.say("Thank you for entering the credentials. we are now connected to your mysql database. Here are the following operations" )
        engine.runAndWait()
        break
    except:
        engine. setProperty("rate", 145)
        engine.say( "the credentials entered are wrong. we are not connected to your mysql database. please try again" )
        engine.runAndWait()
            ...
            if y == 7:
                ...
                while abcd == 'y':
                    ...
                    if s == 'database' or s == 'table':
                        ...
                        print( "Please write either database or table in the input. Try Again." )
                        print()
                        abcd = 'y'
                if s == 'database':
                ...
                while True:
                    try:
                        tbname = input( "Enter the name of the table you would like to create: " )
                        caps(tbname)
                        tbname2 = tbname
                        s = "Name varchar(100) ,Age integer ,Gender varchar(6) ,Aadhar_Number varchar(12) ,Phone_Number varchar(12) ,Vaccine varchar(20) ,Dose varchar(8) ,Date date"
                        command = "create table " + tbname + "(" + s + ");"
                ...
                if s != 0:
                    if z == 1:
                        ...
                        print()
                        print("%20s"%"Name","%20s"%"Age","%10s"%"Gender","%20s"%"Aadhaar Number","%20s"%"Phone Number","%20s"%"Vaccine","%15s"%"Dose","%20s"%"Date")
                        print("===============================================================================================================================================================")
                        for row in data:
                            print( "%20s"%row[0],"%20s"%row[1],"%10s"%row[2],"%20s"%row[3],"%20s"%row[4],"%20s"%row[5],"%15s"%row[6],"%20s"%row[7])
                        ...
                        for i in range( 1 ):
                            ...
                            while ans3 == 'y':
                                try:
                                    engine.say( "here is the menu. What do you want to search." )
                                    engine.runAndWait()
                                    ...
                                    while dcba == 'y':
                                        ...
                                        if w > 0 and w < 7:
                                            ...
                                            dcba = 'y'
                                    if w == 1:
                                        name = input( "Enter the name to find his/her Details:" )
                                        caps(name)
                                        query = "select * from " + tbname + " where Name='" + name + "';"
                                        cursor.execute( query )
                                        results = cursor.fetchall()
                                        nrec = cursor.rowcount
                                        print( "Total records found are: ", nrec )
                                        ...
                                        gender = input( "Enter the gender to find his/her Details:" )
                                        caps(gender)
                                        query = "select * from " + tbname + " where Gender='" + gender + "';"
                                        cursor.execute( query )
                                        results = cursor.fetchall()
                                        nrec = cursor.rowcount
                                        print( "Total records found are: ", nrec )
                                        ...
                                        caps(Aadhar)
                                        query = "select * from " + tbname + " where Aadhar_Number='" + Aadhar + "';"
                                        cursor.execute( query )
                                        results = cursor.fetchall()
                                        nrec = cursor.rowcount
                                        print( "Total records found are: ", nrec )
                                        ...
                                        Phone_Number = phonen()
                                        caps(Phone_Number)
                                        query = "select * from " + tbname + " where Phone_Number='" + Phone_Number + "';"
                                        cursor.execute( query )
                                        results = cursor.fetchall()
                                        nrec = cursor.rowcount
                                        print( "Total records found are: ", nrec )
                                        ...
                                        Vaccine = vaccinen()
                                        query = "select * from " + tbname + " where Vaccine='" + Vaccine + "';"
                                        cursor.execute( query )
                                        results = cursor.fetchall()
                                        nrec = cursor.rowcount
                                        print( "Total records found are: ", nrec )
                                        ...
                                        Dose = input( "Enter the Number Dose(s) to search Details:" )
                                        caps(Dose)
                                        query = "select * from " + tbname + " where Dose='" + Dose + "';"
                                        cursor.execute( query )
                                        results = cursor.fetchall()
                                        nrec = cursor.rowcount
                                        print( "Total records found are: ", nrec )
                ...
                engine.say("If you exit this program then you wont be able to access the same database on this program again" )
                engine.runAndWait()
                print("If you exit this program then you wont be able to access the same database on this program again" )
                ...
                if seuq == 'y':
                    ...
                    engine.say("Stay Safe, Stay Healthy, Health is Wealth")
                    engine.runAndWait()
                    print( "Thankyou for Trying our Program" )
                    print("Stay Safe. Stay Healthy. Health is Wealth")
                    ans = 'n'
                    break
                ...
                while agya == 'y':
                    while True:
                        try:
                            engine.say( "enter the value which need to be inserted in the table" )
                            engine.runAndWait()
                            ...
                            print()
                    command = "insert into " + tbname + "(Name,Age,Gender,Aadhar_Number,Phone_Number,Vaccine,Dose,Date) values('" + name + "'," + age + ",'" + gender + "','" + aadhar + "','" + phone + "','" + vaccine + "','" + dose + "','" + date + "');"
                    cursor.execute( command )
                    db.commit()
                    print()
                ...
                while agyado == 'y':
                    ...
                    print( "Total records are: ", nrec )
                    if nrec != 0:
                        engine.say("Please enter the field in which you want to update the table")
                        engine.runAndWait()
                        print()
                        ...
                        if option == 1:
                            while True:
                                try:
                                    ...
                                    caps(n)
                                    cursor.execute("update " + tbname + " set Name='" + n + "' WHERE Aadhar_Number='" + aad + "';")
                                    db.commit()
                            ...
                            while True:
                                try:
                                    aad = aadhaar2("Age")
                                    n = agen()
                                    cursor.execute("update " + tbname + " set Age=" + n + " WHERE Aadhar_Number='" + aad + "';" )
                                    db.commit()
                                    print( "## Record Updated ##" )
                                    break
                                except:
                            ...
                            while True:
                                try:
                                    ...
                                    caps(n)
                                    cursor.execute("update " + tbname + " set Gender='" + n + "' WHERE Aadhar_Number='" + aad + "';" )
                                    db.commit()
                                    print( "## Record Updated ##" )
                                    break
                                except:
                            ...
                            while True:
                                try:
                                    aad = input( "Enter the Name of person whose Aadhar Number is to be updated:" )
                                    n = aapkaaadhaaraapkipehchaan()
                                    cursor.execute("update " + tbname + " set Aadhar_Number='" + n + "' WHERE Name='" + aad + "';" )
                                    db.commit()
                                    print( "## Record Updated ##" )
                                    break
                                except:
                            ...
                            while True:
                                try:
                                    ...
                                    n = phonen()
                                    cursor.execute("update " + tbname + " set Phone_Number='" + n + "' WHERE Aadhar_Number='" + aad + "';" )
                                    db.commit()
                                    print( "## Record Updated ##" )
                                    break
                                except:
                            ...
                            while True:
                                try:
                                    ...
                                    n = vaccinen()
                                    cursor.execute("update " + tbname + " set Vaccine='" + n + "' WHERE Aadhar_Number='" + aad + "';" )
                                    db.commit()
                                    print( "## Record Updated ##" )
                                    break
                                except:
                            ...
                            while True:
                                try:
                                    ...
                                    n = doseren()
                                    caps(n)
                                    cursor.execute("update " + tbname + " set Dose='" + n + "' WHERE Aadhar_Number='" + aad + "';" )
                                    db.commit()
                                    print( "## Record Updated ##" )
                                    break
                                except:
                ...
                engine.say("You have the following options to arrange Values from the Table")
                engine.runAndWait()
                print("You have the following options to arrange Values from the Table:")
                ...
                if z == 1:
                    ...
                    if s != 0:
                        print()
                        try:
                            engine.say("enter the number by which you want to sort the table")
                            engine.runAndWait()
                            ...
                            print()
                            if w == 1:
                                query = "select * from " + tbname + " order by name " + 'asc' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print( "Total records are: ", nrec )
                                ...
                                query = "select * from " + tbname + " order by Age " + 'asc' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print( "Total records are: ", nrec )
                                ...
                                query = "select * from " + tbname + " order by Gender " + 'asc' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print( "Total records are: ", nrec )
                                ...
                                query = "select * from " + tbname + " order by Vaccine " + 'asc' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print( "Total records are: ", nrec )
                                ...
                                query = "select * from " + tbname + " order by Dose " + 'asc' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print( "Total records are: ", nrec )
                    ...
                    if s != 0:
                        ...
                        try:
                            ...
                            print()
                            if w == 1:
                                query = "select * from " + tbname + " order by name " + 'DESC' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print( "Total records are: ", nrec )
                                ...
                                query = "select * from " + tbname + " order by Age " + 'DESC' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print( "Total records are: ", nrec )
                                ...
                                query = "select * from " + tbname + " order by Gender " + 'DESC' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print( "Total records are: ", nrec )
                                ...
                                query = "select * from " + tbname2 + " order by Vaccine " + 'DESC' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print( "Total records are: ", nrec )
                                ...
                                query = "select * from " + tbname2 + " order by Dose " + 'DESC' + ";"
                                cursor.execute( query )
                                results = cursor.fetchall()
                                nrec = cursor.rowcount
                                print("Total records are: ", nrec)
